...
Insert into jpUrl(urlUserId, urlUri) values(1, 'http://grooveshark.com/#!/masterofsoundtrack/broadcast');
Insert into jpUrl(urlUserId, urlUri) values(1, 'http://lifehacker.com/5540019/five-best-bookmark-management-tools/all');
Insert into jpUrl(urlUserId, urlUri) values(1, 'https://docs.google.com/forms/d/1Q8u2oobP1PhWBgsmvrDp61WWnKp9NF39qibDe0MmVv4/viewanalytics');
Insert into jpUrl(urlUserId, urlUri) values(1, 'http://www.noomuseum.net/');
Insert into jpUrl(urlUserId, urlUri) values(1, 'http://www.unclegram.fr/categories#photogram');
Insert into jpUrl(urlUserId,urlUri) values(1, 'http://ecrans.liberation.fr/');
Insert into jpUrl(urlUserId,urlUri) values(1, 'http://www.vertcerise.com/');
Insert into jpUrl(urlUserId,urlUri) values(1, 'http://www.madmoizelle.com/films-2014-218292');
