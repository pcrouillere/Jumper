...
Sender.prototype.send = function(RequestType,RequestData,ServerAdress,ServerPort,ServerRessource) {
	...
	httpRequest.open("POST", "http://"+ServerAdress+":"+ServerPort+"/"+ServerRessource+"?userid="+"jack"+"&url="+url+"&list="+sender+"&theme="+theme+"&op="+0, true); 
	httpRequest.send(); 
...
<script>
function Bar (pParameters,pTitle) {
...
Bar.prototype.addContainer = function(pClassName) {
	this.cThumbnailContainer = new ThumbnailContainer(this,this.cParameters,this.cTitle);
};
...
function Thumbnail (pParent,pThumbNb,pParameters){
	...
	this.parseParameters(pParameters);
...
Thumbnail.prototype.addImage = function() {
	//this.cImage = new ThumbnailImage(this,'assets/zidane.jpg');
...
Thumbnail.prototype.parseParameters = function(pParam) {
	//console.log(this.cThumbId);
	var param = pParam[this.cThumbId];
...
<script>
function ThumbnailContainer (pParent,pParameters,pTitle){
	JsHtmlObject.call(this, pParent, "div", null);
	
	this.cParameters = new Array();
	this.parseParameters(pParameters);
	...
	this.addClass("container-fluid");
	this.getHtmlObject().innerHTML = '<p class="BarTitle">'+pTitle+'</p>';
	this.addThumbnail();
};
...
ThumbnailContainer.prototype.addThumbnail = function() {
	var i=0;
	var len=this.cParameters.length
	while(i<len){
		var thumb = new Thumbnail(this,this.cNbThumbnails,this.cParameters[this.cNbThumbnails]);
...
ThumbnailContainer.prototype.parseParameters = function(pParameters) {
	var param = JSON.parse(pParameters).parameters;
	for(i=0,len=param.length;i<len;i++){
		this.cParameters.push(param[i]);
	}
};
</script>
...
$(document).ready(function() {
	...
	$("#populateRecommandation").on("click",function(){
		var parameters = '{"parameters":['+
		'{"0":[{"url":"https://www.google.com/intl/en/chrome/browser/"},{"tags":[{"0":"informatique"},{"1":"google"}]}]},'+
		'{"1":[{"url":"http://www.opera.com/fr"},{"tags":[{"0":"opera"},{"1":"browser"},{"2":"informatique"}]}]},'+
		'{"2":[{"url":"http://www.opera.com/fr"},{"tags":[{"0":"opera"},{"1":"info"}]}]},'+
		'{"3":[{"url":"http://wordpress.org/"},{"tags":[{"0":"wordpress"},{"1":"CMS"}]}]},'+
		'{"4":[{"url":"http://getbootstrap.com/"},{"tags":[{"0":"informatique"},{"1":"css"}]}]},'+
		'{"5":[{"url":"https://drupal.org/"},{"tags":[{"0":"informatique"},{"1":"CMS"}]}]},'+
		'{"6":[{"url":"http://www.w3schools.com/"},{"tags":[{"0":"informatique"},{"1":"w3c"}]}]},'+
		'{"7":[{"url":"http://www.apple.com/"},{"tags":[{"0":"informatique"},{"1":"apple"}]}]},'+
		'{"8":[{"url":"http://www.skyrock.com/"},{"tags":[{"0":"skyrock"},{"1":"musique"},{"2":"rap"}]}]}'+
		']}';
		/*url="www.lequipe.fr";
		listTags = ["sport","football","france"];*/
		//data = {userid:'tom',op : '0'};
		/* var result = sender.send(POST_REQUEST,data,"192.168.43.8","8182","ServerRest");
		console.log(result); */
		var bar = new Bar(parameters,"Societe");
	});
...
<section>
	<button id="populateRecommandation">populateRecommandation</button>
	<div id="barWrapper" class="container-fluid"></div>
</section>